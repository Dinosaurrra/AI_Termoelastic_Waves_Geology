...
\noindent Student: Nurshanov D.S. \hfill \rule{4cm}{0.1pt}\[-1mm]
\hfill \small{(signature)}

\vspace{0mm}
\noindent Student: Askarov I.Y. \hfill \rule{4cm}{0.1pt}\[-1mm]
\hfill \small{(signature)}

\vspace{0mm}
\noindent Student: Kassymkhanov T.G. \hfill \rule{4cm}{0.1pt}\[-1mm]
\hfill \small{(signature)}

\vspace{0mm}
\noindent Student: Kaidrakhmetova D.Y. \hfill \rule{4cm}{0.1pt}\[-1mm]
\hfill \small{(signature)}

\vspace{0mm}
\noindent Research advisor: Alipova B. N. \hfill \rule{4cm}{0.1pt}\[-1mm]
\hfill \small{(signature)}
