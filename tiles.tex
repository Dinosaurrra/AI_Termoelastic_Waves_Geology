...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}|>{\centering\arraybackslash}m{2.7cm}|>{\centering\arraybackslash}m{5.2cm}|>{\centering\arraybackslash}m{2.8cm}|>{\centering\arraybackslash}m{2.8cm}|@{}}
\hline
Consultant & Name & \multicolumn{2}{>{\centering\arraybackslash}m{5.6cm}|}{Signature, date} \\ \cline{3-4}
