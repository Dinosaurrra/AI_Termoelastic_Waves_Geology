...
\captionsetup[table]{name=Table,labelsep=endash,justification=raggedright,singlelinecheck=false,font=normalsize,position=above,skip=0.5\baselineskip,belowskip=0.5\baselineskip,indention=\parindent}
...
\titlespacing*{\subsubsection}{0.5\parindent}{0.5\baselineskip}{0.3\baselineskip}
...
\cftsetindents{section}{0pt}{1.0cm}
\cftsetindents{subsection}{0.8cm}{1.2cm}
\cftsetindents{subsubsection}{1.6cm}{1.6cm}
...
\input{chapters/chapter4/summary.tex}
