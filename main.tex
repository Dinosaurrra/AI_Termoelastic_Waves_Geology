...
\captionsetup[table]{name=Table,labelsep=endash,justification=raggedright,singlelinecheck=false,font=normalsize,position=above,skip=0.5\baselineskip,belowskip=0.5\baselineskip,margin={\parindent,0pt}}
