...
\captionsetup[table]{name=Table,labelsep=endash,justification=raggedright,singlelinecheck=false,font=normalsize,position=above,skip=\baselineskip,belowskip=\baselineskip,margin=0pt}
\makeatletter
\renewcommand{\fnum@table}{\hspace*{\parindent}\tablename~\thetable}
\makeatother
