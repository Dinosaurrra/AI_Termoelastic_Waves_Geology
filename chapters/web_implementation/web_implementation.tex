...
\caption{Prediction setup panel of the web interface}
\label{fig:web-setup}
\end{figure}
...
\caption{Planar domain visualisation with source, probe, and
propagation arrow}
...
\caption{Prediction result panel with diagnostics strip}
