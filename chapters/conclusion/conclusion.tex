...
The theoretical part (Chapters~1 and~2) established the physical
...
The methodological and implementation part (Chapters~3--5) described
the comparative prediction methodology, the COMSOL setup that
produced the per-rock 2D datasets, and the four surrogate
architectures. A v2 API contract was frozen and implemented
...
The empirical part (Chapter~7) compared the four routes on a balanced
...
Chapter~7 requires a retraining pass that is out of scope for the
...
in geological media. With the limitations stated above and the
future work outlined, the prototype provides a reproducible
foundation for the continued investigation of AI-assisted prediction
in geophysics.
