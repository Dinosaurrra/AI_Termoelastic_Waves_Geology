...
The elastic parameters describe the mechanical response of the medium. Density controls inertia, while the elastic moduli determine how strain produces stress and how mechanical disturbances propagate. Young's modulus and Poisson's ratio may be used as primary parameters, while the shear modulus, bulk modulus, and Lame parameter can be derived for the isotropic approximation. These parameters are directly related to wave propagation because they determine the stiffness-to-density ratio controlling elastic wave speeds.
