...
\end{equation}
where \(\theta
_{full}\) is the trainable parameter set in full fine-tuning mode, \(\theta_{enc}\) represents encoder parameters, \(\theta_{proc}\) represents processor parameters, and \(\theta_{dec}\) represents decoder parameters.
