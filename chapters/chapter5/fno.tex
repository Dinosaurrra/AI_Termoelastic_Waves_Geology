...
\right],
\]
where \(T(\mathbf{x}, t)\) is the temperature field, and \(u(\mathbf{x}, t)\), and \(v(\mathbf{x}, t)\)) are displacement-related field components extracted from the simulation data.
