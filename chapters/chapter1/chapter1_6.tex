...
\end{equation}
These formulas show that wave velocity is controlled by the ratio between elastic stiffness and density. Elastic stiffness provides the restoring force that allows a disturbance to propagate, while density represents inertia, or resistance to acceleration. Therefore, wave speed increases when stiffness is high relative to density and decreases when the medium is compliant or highly fractured \cite{aki2002,mavko2009}.
...
In real geological materials, the simple isotropic velocity formulas must be interpreted with caution. Porosity, cracks, mineral composition, saturation, confining pressure, temperature, and anisotropy all influence the effective elastic moduli and density. Increased porosity and compliant microcracks usually reduce the effective stiffness of the rock and lower seismic velocities. Higher confining pressure may close cracks and strengthen grain contacts, thereby increasing the effective moduli and wave speeds. Fluid saturation modifies the compressibility of the pore space and can significantly affect \(V_P\), while fractures and bedding may introduce direction-dependent wave velocities \cite{mavko2009,jaeger2007,crampin1981,thomsen1986}.

Temperature also matters for elastic wave propagation in rocks. Heating can change mineral stiffness, promote thermal expansion, open or extend microcracks, and alter the stress state of the rock. As a result, elastic moduli and wave velocities may change with temperature. This is particularly relevant in thermoelastic problems, where temperature is not only a background condition but also a field that may interact with deformation and stress. Therefore, even though the formulas for \(V_P\) and \(V_S\) are derived for ideal homogeneous isotropic solids, they provide the fundamental physical link between density, elastic stiffness, and wave propagation in geological media \cite{robertson1988,turcotte2014,mavko2009}.
