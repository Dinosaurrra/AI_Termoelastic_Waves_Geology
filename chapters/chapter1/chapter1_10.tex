...
Coupled thermoelasticity describes the simultaneous interaction of thermal and mechanical fields in a deformable solid. In classical elasticity, the mechanical state of a body is described through displacement, strain, and stress. In heat conduction, the thermal state is described through the temperature field. Thermoelasticity combines these two descriptions by recognizing that temperature changes can produce strain and stress, while deformation can also influence the thermal state of the material. In geological media, this coupling is important because rocks may experience mechanical loading, heat transfer, and temperature-dependent deformation at the same time \cite{nowacki1986,boley1960}.
...
A convenient variable for describing temperature change is the temperature perturbation
\begin{equation}
\theta = T - T_0,
\end{equation}
...
Mechanical motion is governed by the equation of motion. Neglecting body forces for simplicity, it can be written in index notation as
\begin{equation}
