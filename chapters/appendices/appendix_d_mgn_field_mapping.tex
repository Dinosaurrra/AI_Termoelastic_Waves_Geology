...
against the canonical 20-field thermoelastic state of the
\texttt{sandstone\_comsol\_real} dataset. Loading the same checkpoint
against the 2D \texttt{*\_rod\_2d} datasets used in this thesis
requires a per-field rewrite that places the PINN-exported
\texttt{stress\_normal}, \texttt{stress\_shear}, \texttt{strain},
\texttt{displacement}, \texttt{velocity}, and \texttt{temperature}
columns in the exact order the network expects. The listing below
shows the mapping kernel of
\path{mgn-service/scripts/build\_2d\_mgn\_datasets.py}.
...
dynamic_state[..., 2]  = strain[..., 4]            # solid.exz (~0)
dynamic_state[..., 3]  = strain[..., 1]            # solid.ey
dynamic_state[..., 4]  = strain[..., 5]            # solid.eyz (~0)
dynamic_state[..., 5]  = strain[..., 2]            # solid.ez  (~0)
...
dynamic_state[..., 9]  = stress_shear[..., 1]      # solid.sxz (~0)
dynamic_state[..., 10] = stress_normal[..., 1]     # solid.sy
dynamic_state[..., 11] = stress_shear[..., 2]      # solid.syz (~0)
dynamic_state[..., 12] = stress_normal[..., 2]     # solid.sz
...
dynamic_state[..., 18] = displacement[..., 2]      # w  (~0)
dynamic_state[..., 19] = velocity[..., 2]          # wt (~0)
