\thesisappendix{PINN composite loss assembly}{app:pinn-loss}

The PINN training objective described in Chapter~7 has four
...
source identified in Section~3.5; it is what distinguishes the
