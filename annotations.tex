...
\vspace{5mm}
\noindent\textit{\textbf{Кілт сөздер:} термосерпімділік, геологиялық орта, серпімді толқындар, жылу өткізгіштік, термиялық кернеу, тау жыныстары, бағыттық таралу, анизотропия, геофизика, жасанды интеллект}
...
\vspace{5mm}
\noindent\textit{\textbf{Ключевые слова:} термоупругость, геологическая среда, упругие волны, теплопроводность, тепловое напряжение, горные породы, направленное распространение, анизотропия, геофизика, искусственный интеллект}
...
\vspace{5mm}
\noindent\textit{\textbf{Keywords:} thermoelasticity, geological media, elastic waves, heat conduction, thermal stress, rocks, directional propagation, anisotropy, geophysics, artificial intelligence}
