...
\vspace{5mm}
\noindent\textbf{Кілт сөздер:} термосерпімділік, геологиялық орта, серпімді толқындар, жылу өткізгіштік, термиялық кернеу, тау жыныстары, бағыттық таралу, анизотропия, геофизика, жасанды интеллект.
...
\vspace{5mm}
\noindent\textbf{Ключевые слова:} термоупругость, геологическая среда, упругие волны, теплопроводность, тепловое напряжение, горные породы, направленное распространение, анизотропия, геофизика, искусственный интеллект.
